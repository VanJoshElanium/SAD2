                                        ...
                                        <tbody>
                                            @forelse($stockins as $stockin)
                                                <tr>    
                                                    ...
                                                    <td>{{$stockin->fname}} {{$stockin->mname}}. {{$stockin->lname}}</td>
                                                    <td> 
                                                        <button data-target="#viewSI" data-toggle="modal" data-id='{{$stockin->si_date}}' class="viewSI-btn btn btn-primary btn-fill">
                                                            View
                                                        </button>
                                                    </td>
                                                    <td>
