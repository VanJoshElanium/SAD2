                                                        ...
                                                        <table class="table table-hover table-striped" cellspacing="0" width="100%">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr style="text-align: left">
                                                                    ...
                                                                    <td>
                                                                        @if($term_item->ti_returned != 0 || $term_item->ti_udamaged != 0 || $term_item->ti_rdamaged != 0)
                                 ...
                                 <div class="row form-group">
                                    <div class="{{ $errors->editItem->has('edit_item_original') ? ' has-error' : '' }}">
                                        <div class="col-md-4">
                                            ...
                                            <input  class="form-control" type="number" id="edit_item_original" min="1" name="edit_item_original" required value="{{ old('edit_item_original') }}">
                            ...
                            <div class="row form-group col-md-12">
                                <div class="{{$errors->addExpense->has('add_exp_name') ? ' has-error' : ''}}"> 
                                    <div class="col-md-8">  
                                        ...
                                        <input class="form-control" type="text" id="add_exp_name" name="add_exp_name" required value="{{old('add_exp_name')}}"> 
                                ...
                                <div class="{{$errors->addExpense->has('add_exp_amt') ? ' has-error' : ''}}"> 
                                    <div class="col-md-4">  
                                        ...
                                        <input type="number"  name="add_exp_amt" id="add_exp_amt" class="form-control" min="1" required value="{{old('add_exp_amt')}}">
    ...
    <div class="modal fade" role="dialog" id="payCustomer">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <center> <h4 class="modal-title">Confirm Payment</h4> </center>
                </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function(event) {
                ...
                if ({!!count($errors->editCustomer)!!} > 0){
                    $("#viewCustomer-{{ session()-> get( 'error_id' ) }}").on('click', function (e) {
                 
                        e.preventDefault();

                        $('#edit_fname').val("{{old('edit_fname')}}");
                        $('#edit_mname').val("{{old('edit_mname')}}");
                        $('#edit_lname').val("{{old('edit_lname')}}");
                        $('#edit_gender').val("{{old('edit_gender')}}");
                        $('#edit_cnum').val("{{old('edit_cnum')}}");
                        $('#edit_addr').val("{{old('edit_addr')}}");
